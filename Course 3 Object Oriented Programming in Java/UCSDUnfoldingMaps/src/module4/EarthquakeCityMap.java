 ...
 * Date: July 17, 2015
 * @author Lynn Zhang
 * 2021-4-22 22:51 - 23:10
 * 2021-4-23 07:35 - 08:38
 * */
public class EarthquakeCityMap extends PApplet {
	...
	//private List<EarthquakeMarker> quakeMarkers;
	...
	private void printQuakes() 
	{
		...
		for (Marker cm: countryMarkers) {
			...
			for (Marker m: quakeMarkers) {
				...
				if(qm.isOnLand() && qm.getProperty("country") == cm.getProperty("name")) {
					quakeCounter += 1;
				}
			}	
			System.out.println(cm.getProperty("name") + ": " + quakeCounter);
		}
		for (Marker m: quakeMarkers) {
			EarthquakeMarker qm = (EarthquakeMarker)m;
			if(!qm.isOnLand()) {
		...
		System.out.println("OCEAN QUAKERS: " + oceanCounter);
