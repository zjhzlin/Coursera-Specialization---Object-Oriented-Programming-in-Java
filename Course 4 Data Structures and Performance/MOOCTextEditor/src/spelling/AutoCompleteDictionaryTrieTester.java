...
public class AutoCompleteDictionaryTrieTester {
	...
	public void testIsWord()
	{
		...
		assertEquals("Testing isWord on large: downhil", false, largeDict.isWord("downhil"));
		assertEquals("Testing isWord on large: downhille", false, largeDict.isWord("downhille"));
